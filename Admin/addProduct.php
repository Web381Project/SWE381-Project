                       ...
                       <ul class="main-nav">
                        ...
                        <i class="fa fa-search"></i>
                            ...
                            <div class="form">
                                <form>
				                    		product name
				                        	<input type="text" name="form-first-name" placeholder="product name" class="form-first-name form-control" id="form-first-name">
				                        	price
				                        	<input type="text" name="form-last-name" placeholder="price" class="form-last-name form-control" id="form-last-name">
				                        	Description
				                        	<input type="text" name="form-email" placeholder="description" class="form-email form-control" id="form-email">
				                        
				                        <a href="Home.html"><button class="btn">Add Product</button></a>
				                    </form>
                                </div>
